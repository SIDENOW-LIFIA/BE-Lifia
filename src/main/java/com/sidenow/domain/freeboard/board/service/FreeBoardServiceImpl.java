...
import com.sidenow.domain.freeboard.board.exception.FreeBoardLikeHistoryNotFoundException;
import com.sidenow.domain.freeboard.board.repository.FreeBoardLikeRepository;
