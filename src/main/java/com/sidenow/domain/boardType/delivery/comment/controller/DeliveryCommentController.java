package com.sidenow.domain.boardType.delivery.comment.controller;

import com.sidenow.domain.boardType.delivery.comment.dto.req.DeliveryCommentRequest.DeliveryCommentCreateRequest;
import com.sidenow.domain.boardType.delivery.comment.dto.req.DeliveryCommentRequest.DeliveryCommentUpdateRequest;
import com.sidenow.domain.boardType.delivery.comment.dto.res.DeliveryCommentResponse.DeliveryGetCommentListResponse;
import com.sidenow.domain.boardType.delivery.comment.service.DeliveryCommentService;
...
import static com.sidenow.domain.boardType.delivery.comment.constant.DeliveryCommentConstants.DeliveryCommentSuccessMessage.*;
import static com.sidenow.domain.boardType.delivery.comment.dto.res.DeliveryCommentResponse.DeliveryCommentCreateResponse;
import static com.sidenow.domain.boardType.delivery.comment.dto.res.DeliveryCommentResponse.DeliveryCommentUpdateResponse;
