...
import com.sidenow.domain.boardType.caution.board.entity.CautionLike;
import com.sidenow.domain.boardType.caution.board.exception.CautionIdNotFoundException;
import com.sidenow.domain.boardType.caution.board.exception.CautionLikeHistoryNotFoundException;
import com.sidenow.domain.boardType.caution.board.repository.CautionLikeRepository;
...
import com.sidenow.domain.boardType.caution.board.dto.res.CautionResponse.*;
...
public class CautionServiceImpl implements CautionService {
    ...
    public CautionUpdateResponse updateCaution(Long id, CautionUpdateRequest req, MultipartFile image){
        ...
        // 게시글 작성자가 맞는지 확인
        memberRepository.findById(caution.getMember().getMemberId()).orElseThrow(MemberNotExistException::new);
